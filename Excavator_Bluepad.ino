...
#define swingMotor0  13  // Controls cab swing movement
#define swingMotor1  12  // Controls cab swing movement
...
#define clawMotor1   26 // Controls claw rotation movement
